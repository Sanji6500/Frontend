...
import EditAdevertising from "./Popup/EditAdevertising";

import useAdvertisingBrowser from "../../Hocks/useAdvertisingBrowser";

import { Alertbox } from "../../Elements/Alertbox";

function Advertising() {
  const { loadingdataGetAdds, modifiedData, Columns, SerachField } =
    useAdvertisingBrowser();
      ...
      <div className=" flex flex-col p-16">
        ...
        <div className=" mt-5 ">
          <DataTableV2
            ...
            Data={!loadingdataGetAdds ? modifiedData : []}
