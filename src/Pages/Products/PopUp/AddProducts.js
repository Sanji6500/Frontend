...
import useAddProduct from "../../../Hocks/useAddProduct";

import { Alertbox } from "../../../Elements/Alertbox";

function AddProducts({ Trigger, setClose, setAlert }) {
  ...
  const {
    ...
    errors,
  } = useAddProduct(setAlert, setClose, setAlertboxfailed);
            ...
            >
              ...
              <div className=" flex  mt-2  float-right">
                <NormalButton
                  ...
                  width="175px"
                />
                <SubmitButton value="Add Product" width="175px" />
              </div>
            </form>
          </div>
        </div>
